...
template< > struct IntegerChooser< 1 >
{
    enum { size = 1 };
    typedef uint8_t IntegerType;
};


template< > struct IntegerChooser< 2 >
{
    enum { size = 2 };
    typedef uint16_t IntegerType;
};
...
template< int D > using SimplePointFuint8 = SimplePoint< D, uint8_t >;
...
template< int D > using SimpleEuklidianMetricFdouble = EuklidianMetric< D,
    double,
    SimplePointFdouble >;
template< int D > using SimpleEuklidianMetricFuint8 = EuklidianMetric< D,
    int8_t, 
    SimplePointFuint8 >;
...
template< int D >
using SimpleEuklidianSpaceFuint8 = LinearSpace< D,
      SimpleEuklidianMetricFuint8 >;
template< int D >
...
template< int D >
using EuklidianSpaceCompressedFuint8 = LinearSpaceCompressed< D,
      SimpleEuklidianMetricFuint8 >;
template< int D >
